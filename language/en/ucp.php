...
$lang = array_merge($lang, array(
		'TERMS_OF_USE_CONTENT'	=> '<p>By registering for an account on the forum, you agree to:</p><ul><li><strong>Maintain focus.</strong> Keep posts focused on the 6502 and its relatives, electronics, computers, and the like. Please leave politics, religion, and other unrelated topics at the door.</li><li><strong>Be respectful.</strong> Be kind and helpful to other members. Personal attacks, insults, and condescending behavior have no place here. Remember that our members range from absolute beginners to industry veterans.</li><li><strong>Keep it family-friendly.</strong> People of all ages use this forum, so please do not post vulgar language or inappropriate content.</li><li><strong>Preserve your posts.</strong> Don\'t request your posts be deleted because it disrupts the thread history for everyone else.</li><li><strong>Respect our process.</strong> Leave moderating to the moderators. Do not engage with questionable content. Use the "report post" button instead. Moderators have the final word on what is acceptable.</li></ul><p>We reserve the right to remove content or ban accounts at our discretion. Be cool to others, talk about your projects, and have a good time.</p>',
...
$lang = array_merge($lang, array(
	...
	'AGREE'							=> 'I\'ll play well with others',
	...
	'FOE_MESSAGE'				=> 'Message from blocked user',
	'FOES_EXPLAIN'				=> 'Blocked users will be ignored by default. Posts by these users will not be fully visible. Private messages from blocked users are still permitted. Please note that you cannot block moderators or administrators.',
	'FOES_UPDATED'				=> 'Your blocked users list has been updated successfully.',
	...
	'FRIEND_MESSAGE'			=> 'Message from bookmarked user',
	'FRIENDS'					=> 'Bookmarked users',
	'FRIENDS_EXPLAIN'			=> 'Bookmarked users give you quick access to members you communicate with frequently.',
	'FRIENDS_OFFLINE'			=> 'Offline',
	'FRIENDS_ONLINE'			=> 'Online',
	'FRIENDS_UPDATED'			=> 'Your bookmarked users list has been updated successfully.',
	...
	'NOT_ADDED_FRIENDS_ANONYMOUS'	=> 'You cannot bookmark the anonymous user.',
	'NOT_ADDED_FRIENDS_BOTS'		=> 'You cannot bookmark bots.',
	'NOT_ADDED_FRIENDS_FOES'		=> 'You cannot bookmark users who are on your blocked list.',
	'NOT_ADDED_FRIENDS_SELF'		=> 'You cannot bookmark yourself.',
	'NOT_ADDED_FOES_MOD_ADMIN'		=> 'You cannot block administrators and moderators.',
	'NOT_ADDED_FOES_ANONYMOUS'		=> 'You cannot block the anonymous user.',
	'NOT_ADDED_FOES_BOTS'			=> 'You cannot block bots.',
	'NOT_ADDED_FOES_FRIENDS'		=> 'You cannot block users who are on your bookmarked list.',
	'NOT_ADDED_FOES_SELF'			=> 'You cannot block yourself.',
	'NOT_AGREE'						=> 'This isn\'t the place for me',
	...
	'NO_FOES'					=> 'No blocked users',
	'NO_FRIENDS'				=> 'No bookmarked users',
	'NO_FRIENDS_OFFLINE'		=> 'No bookmarked users offline',
	'NO_FRIENDS_ONLINE'			=> 'No bookmarked users online',
	...
	'UCP_ZEBRA'						=> 'Users',
	'UCP_ZEBRA_FOES'				=> 'Blocked users',
	'UCP_ZEBRA_FRIENDS'				=> 'Bookmarked users',
	'UNDISCLOSED_RECIPIENT'			=> 'Undisclosed Recipient',
	'UNKNOWN_FOLDER'				=> 'Unknown folder',
	'UNWATCH_MARKED'				=> 'Unwatch marked',
	'UPLOAD_AVATAR_FILE'			=> 'Upload a file for your avatar',
	...
	'YOUR_FOES'					=> 'Your blocked users',
	'YOUR_FOES_EXPLAIN'			=> 'To unblock users, select them and click submit.',
	'YOUR_FRIENDS'				=> 'Your bookmarked users',
	'YOUR_FRIENDS_EXPLAIN'		=> 'To remove users, select them and click submit.',
